...
<div id="tooplate_main">
    ...
    <style>
     ...
     <form name="login" action="AddCountryAction.jsp" method="post">
         <table  cellpadding="10px" cellspacing="10px" bgcolor="orange" align="left" style="">
          <tr><td><font color="black">Country Name</font></td><td><input type="text" name="countryname" required style="text-transform: uppercase;"></td></tr>
