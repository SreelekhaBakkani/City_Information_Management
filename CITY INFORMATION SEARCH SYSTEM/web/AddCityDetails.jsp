<%-- 
    Document   : AddCityDetails
    Created on : 11 May, 2019, 11:01:11 AM
    Author     : VENKAT
--%>
<%-- 
    Document   : AdminHome
...
<div id="tooplate_main">
    ...
    <h2>Add  City Information Here</h2>
    <style>
       
     
    </style>
     <form name="login" action="AddCityDetails" method="post" enctype="multipart/form-data">
...
%>   
      ...
      <tr><td><font color="black">About</td><td><input type="text" name="about" required placeholder="hotels,restarents,buses"></input></td></tr>
      <tr><td><font color="black">Description</td><td><textarea name="des"></textarea></td></tr> 
      <tr><td><font color="black">Select Photo</font></td><td><input type="file" name="image"></input></td></tr>
