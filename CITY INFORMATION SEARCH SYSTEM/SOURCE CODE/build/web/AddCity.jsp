<%-- 
    Document   : AdminHome
    Created on : 27 Apr, 2019, 12:37:19 PM
    Author     : VENKAT
--%>
        ...
        <div id="tooplate_menu" class="ddsmoothmenu">
            <ul>
              <li><a href="AdminHome.jsp" class="selected">Home</a></li>
          		<li><a href="AdminHome.jsp">Add Details</a>
                     <ul>
...
<div id="tooplate_main">
    ...
    <h2>Add City Name Here</h2>
    <style>
       
     
    </style>
     <form name="login" action="AddCityAction.jsp" method="post">
         <table  cellpadding="10px" cellspacing="10px" bgcolor="orange" align="left" style="">
                         <tr><td><font color="black">Country Name</font></td><td><select name="countryname" required style="text-transform: uppercase;">
...
%>   
                                     ...
                                     <tr><td><font color="black">State Name</font></td><td><select name="statename" required style="text-transform: uppercase;">
                                         <%try
    {
      Connection con1=Dbconnection.getConnection();
      Statement st1= con1.createStatement();
      ResultSet rs1=st1.executeQuery("select * from state");
      while(rs1.next())
      {%>
...
%>   
      ...
      <tr><td><font color="black">City Name</td><td><input type="text" name="city" required style="text-transform: uppercase;"></input></td></tr>
