...
<div id="tooplate_main">
    <img src="images/registerjpg.gif" width="300px" height="300px" align="right" style="margin-top: 150px;"></img>
    <h2 style="marign-right:100px;">User Register Here</h2>
    <form name="login" action="RegisterAction.jsp" method="post">
        <table  cellpadding="10px" cellspacing="10px" bgcolor="orange" align="left">
            <tr><td><font color="black">First Name</font></td><td><input type="text" name="fname" required></td></tr>
            <tr><td><font color="black">Last Name</font></td><td><input type="text" name="lname" required></td></tr>
            <tr><td><font color="black">Email</font></td><td><input type="email" name="email" required></td></tr>
            <tr><td><font color="black">Mobile Number</font></td><td><input type="text" name="mobile" required></td></tr>
            <tr><td><font color="black">Address</font></td><td><textarea  name="address" required></textarea></td></tr>
                        <tr><td><font color="black">Gender</font></td><td><select name="gender" required>
