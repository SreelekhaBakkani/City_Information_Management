...
<div id="tooplate_main">
    ...
    <h2><center>View City information</center></h2>
       <table cellpadding="10px" cellspacing="10px;" border="2px">
        ...
        <td><font size="5" color="white">About </td>
        <td><font size="5" color="white">Description</td>
        <td><font size="5" color="white">Image</td>
...
<%
    ...
    try
    {
      ...
      ResultSet rs=st.executeQuery("select * from addcitydetails where countryname='"+countryname+"' and statename='"+statename+"' and cityname='"+cityname+"' and about='"+about+"' ");
   while(rs.next())
    {%>
    <tr>
         ...
         <td><font size="4" color="blue"><%=rs.getString(2)%></td>
          <td><font size="4" color="blue"><%=rs.getString(3)%></td>
           <td><font size="4" color="blue"><%=rs.getString(4)%></td>
            ...
            <td><image src="view.jsp?id=<%=rs.getString(7)%>" width="150px" height="150px"></image></td>
