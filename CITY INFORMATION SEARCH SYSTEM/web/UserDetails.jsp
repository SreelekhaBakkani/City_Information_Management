...
<div id="tooplate_main">
    ...
    <h2><center>View User Details </center></h2>
    <table cellpadding="10px" cellspacing="10px;" border="2px">
        <tr>
            <td> <font size="5" color="white">First Name</td>
        <td><font size="5" color="white">Last Name</td>
        <td><font size="5" color="white">Email Id</td>
        <td><font size="5" color="white">Mobile</td>
        <td><font size="5" color="white">Address</td>
        <td><font size="5" color="white">Gender</td>
        <td><font size="5" color="white">Username</td>
        </tr>
         ...
         <td><font size="4" color="blue"><%=rs.getString(2)%></td>
          <td><font size="4" color="blue"><%=rs.getString(3)%></td>
           <td><font size="4" color="blue"><%=rs.getString(4)%></td>
            <td><font size="4" color="blue"><%=rs.getString(5)%></td>
             <td><font size="4" color="blue"><%=rs.getString(6)%></td>
              <td><font size="4" color="blue"><%=rs.getString(7)%></td>
