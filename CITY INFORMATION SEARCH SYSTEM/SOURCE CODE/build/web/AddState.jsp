...
<div id="tooplate_main">
    ...
    <h2>Add State Name Here</h2>
    <style>
       
     
    </style>
     <form name="login" action="AddStateAction.jsp" method="post">
...
<%try
    {
      ...
      %>     
           ...
           <tr><td><font color="black">State Name</font></td><td><input type="text" name="statename" required style="text-transform: uppercase;"></td></tr>
