...
<div id="tooplate_main">
    <img src="images/User.jpg" width="300px" height="300px" align="right"></img>
    <h2 style="marign-right:100px;">User Login Here</h2>
    <form name="login" action="UserLogin.jsp" method="post">
      ...
      <p><a href="Register.jsp"><font size="5">New User</a></p>
            </form>
    <div class="cleaner"></div>
</div>
